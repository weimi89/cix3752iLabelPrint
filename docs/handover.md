...
最後更新：**2026-09-10（v1.0.0 已發佈；網頁版隱藏現場作業頁，未提交）**　目前版本：**v1.0.0（已發佈，九項產物齊全，`latest.json` 生效）**

---

## 未提交（2026-09-10，v1.0.0 之後）：網頁版不提供現場作業頁
...
- **尚未發版**:這個改動要等 v1.0.1 才會到現場。v1.0.0 的 release notes 寫的是 v1.0.0 當下的行為
  (當時確實含入倉驗單),不需回頭改。
